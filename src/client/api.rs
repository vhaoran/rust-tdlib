    ...
    R: TdLibClient + Clone,
{
    ...
    pub async fn add_proxy<C: AsRef<AddProxy>>(&self, add_proxy: C) -> Result<AddedProxy> {
    ...
    // add by whr
    /// @description Returns properties of a message;
    /// this is an offline request
    /// @chat_id Chat identifier
    /// @message_id Identifier of the message
    pub async fn get_message_properties<C: AsRef<GetMessageProperties>>(
        &self,
        body: C,
    ...
    // @limit The maximum number of forum topics to be returned; up to 100. For optimal performance, the number of
    //    @limit test must set value,1--99
    ///
